...
import { NewList } from '@app/Lists/NewList';
import { MyLists } from '@app/Lists/MyLists';
...
const routes: AppRouteConfig[] = [
  ...
  },
  {
    ...
    label: 'Support',
    path: '/support',
    title: 'ShoppingList | Support Page',
  },
];
